                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-8 col-md-9 col-sm-10">
                        <div class="hero__caption">
                            <span data-animation="fadeInLeft" data-delay=".1s">WYAB FORUM ONLINE REGISTRATION</span>
                            {{-- <h1 data-animation="fadeInLeft" data-delay=".5s">Women and Youth African Business ForumOnline Registration</h1> --}}
                            <!-- Hero-btn -->
                            <div class="slider-btns">
                                <a data-animation="fadeInLeft" data-delay="1.0s" href="industries.html" class="btn hero-btn">Register</a>
        ...
        <div class="single-slider slider-height d-flex align-items-center">
            <div class="container">
                <div class="row">
                    <div class="col-xl-8 col-lg-8 col-md-9 col-sm-10">
                        <div class="hero__caption">
                            <span data-animation="fadeInLeft" data-delay=".1s">Easy  Registration</span>
                            <h1 data-animation="fadeInLeft" data-delay=".5s">Women and Youth african Business Forum</h1>
                            <!-- Hero-btn -->
                            <div class="slider-btns">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="about-caption mb-50">
                    ...
                    <div class="section-tittle mb-35">
                        <h3 style="color: #F05A25">Promoting Gender Equity Unleashing the
                            Potential of Africa’s Women and Youth in
                            Trade for Africa Integration</h3>
                    </div>
                    <p>Join us.</p>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10">
                        <div class="single-caption mb-20">
                            ...
                            <div class="caption">
                                <h5>Where</h5>
                                <p>Golden Tulip, Zanzibar Near Airport</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10">
                            ...
                            <div class="accordion" id="accordionExample">
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                        <div class="card-body">
                                            1 Panel session after tea break and then 2 Panel sessions after lunch
                                        </div>
                                    </div>
                                </div>
                                <!-- single-two -->
                                <div class="card">
                                    ...
                                    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                                        ...
                                        <div class="card-body">
                                            2 Panel sessions before lunch and 2 Panel sessions after lunch
                                        </div>
                                        <div class="card-body">
                                            Deliberations
                                        </div>
...
<!-- Pricing Card End -->
<!--? Brand Area Start-->
<section class="work-company section-padding30" style="background: #F05A25;">
    <div class="container">
